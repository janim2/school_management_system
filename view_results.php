                        ...
                        <div class="span12">
                            <b>
                                ...
                                <div style="margin:auto; text-align:center">
                                    <p id="pinfo"><?= strtoupper($org_name); ?></p>
                                    <p></p>
                                    <p>RESULTS FOR SEMESTER <?= $sem ?>, <?= strtoupper(fetchAcademicYearUsingID($con, $year)); ?> ACADEMIC YEAR</p>
                                </div>
                                        ...
                                        if($results_statement->rowCount() > 0){
                                            ...
                                            <p>
                                                ...
                                                <script type="text/javascript">
                                                    $("#buttonresslipprint").click(function () {
                                                        $.ajax({
                                                            url: 'database/reports/results_report.php',
                                                            data: {
                                                                year: <?= $year?>,
                                                                sem: <?= $sem; ?>
                                                            },
